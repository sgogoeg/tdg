...
# Find all input files in the inputs directory matching the pattern 'input_Z8_*.csv'
input_files = glob.glob(os.path.join('inputs', 'input_Z10_*.csv'))
...
with open(log_file_path, 'w') as log_file:
    for input_file in input_files:
        ...
        output_file = os.path.join(outputs_dir, 'output_I10_' + os.path.basename(input_file).replace('input_', ''))
