...
with open('/home/sgogoeg/heptools/micromegas_6.0/EFFRealPortal2/data.par', 'w') as tempfile:
    pass
...
with open('input.csv', 'r') as csvfile:
    ...
    for row in reader:
        ...
        result = subprocess.run(['./main', '/home/sgogoeg/heptools/micromegas_6.0/EFFRealPortal2/data.par'], cwd = "/home/sgogoeg/heptools/micromegas_6.0/EFFRealPortal2" ,stdout=subprocess.PIPE, text=True)
